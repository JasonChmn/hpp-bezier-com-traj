...
typedef curves::bezier_curve  <double, double, 3, true, point_t > bezier_t;
typedef curves::bezier_curve  <double, double, 3, true, waypoint_t > bezier_wp_t;
typedef curves::bezier_curve  <double, double, 6, true, point6_t> bezier6_t;
